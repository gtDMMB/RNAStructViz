...
Fl_File_Chooser_Custom::Fl_File_Chooser_Custom(const char *d, const char *p, int t, const char *title) : 
  ...
  { window = new Fl_Double_Window(MAX(490, DEFAULT_SAWIDGET_WIDTH + 20), 380 + DEFAULT_SAWIDGET_HEIGHT + 18, "Choose File");
...
void Fl_File_Chooser_Custom::show_window() {
     ...
     if(activeWindowGroup) {
          activeWindowGroup->show();
	  activeWindowGroup->redraw();
     }
     if(ext_group) {
          ext_group->redraw();
	  ext_group->show();
...
Fl_Widget* Fl_File_Chooser_Custom::add_extra(Fl_Widget* gr) {
  ...
  if (gr) {
    ...
    gr->position(17, okButton->y()+okButton->h() + 5);
    window->add(gr);
    ext_group=gr;
    window->resizable(svres);
  }
...
Fl_Preferences* Fl_File_Chooser_Custom::prefs_ = NULL;

const char      *Fl_File_Chooser_Custom::add_favorites_label = "Add to Favorites";
const char      *Fl_File_Chooser_Custom::all_files_label = "All Files (*)";
const char      *Fl_File_Chooser_Custom::custom_filter_label = "Custom Filter";
const char      *Fl_File_Chooser_Custom::existing_file_label = "Please choose an existing file!";
const char      *Fl_File_Chooser_Custom::favorites_label = "Favorites";
const char      *Fl_File_Chooser_Custom::filename_label = "Filename:";
const char      *Fl_File_Chooser_Custom::filesystems_label = Fl::system_driver()->filesystems_label();
const char      *Fl_File_Chooser_Custom::manage_favorites_label = "Manage Favorites";
const char      *Fl_File_Chooser_Custom::new_directory_label = "New Directory?";
const char      *Fl_File_Chooser_Custom::new_directory_tooltip = "Create a new directory.";
const char      *Fl_File_Chooser_Custom::preview_label = "Preview";
const char      *Fl_File_Chooser_Custom::save_label = "Save";
const char      *Fl_File_Chooser_Custom::show_label = "Show:";
const char      *Fl_File_Chooser_Custom::hidden_label = "Show hidden files";
Fl_File_Sort_F  *Fl_File_Chooser_Custom::sort = fl_numericsort;
...
void
Fl_File_Chooser_Custom::directory(const char *d)// I - Directory to change to
{
  char	*dirptr;		// Pointer into directory
  char  fixpath[FL_PATH_MAX];   // Path with slashes converted


//  printf("Fl_File_Chooser_Custom::directory(\"%s\")\n", d == NULL ? "(null)" : d);
...
//
// 'Fl_File_Chooser_Custom::favoritesButtonCB()' - Handle favorites selections.
//

void
Fl_File_Chooser_Custom::favoritesButtonCB()
{
...
//
// 'Fl_File_Chooser_Custom::favoritesCB()' - Handle favorites dialog.
//

void
Fl_File_Chooser_Custom::favoritesCB(Fl_Widget *w)
					// I - Widget
{
  int		i;			// Looping var
...
//
// 'Fl_File_Chooser_Custom::fileListCB()' - Handle clicks (and double-clicks) in the
//                                   Fl_File_Browser.
//

void
Fl_File_Chooser_Custom::fileListCB()
{
...
//
// 'Fl_File_Chooser_Custom::fileNameCB()' - Handle text entry in the FileBrowser.
//

void
Fl_File_Chooser_Custom::fileNameCB()
{
  char		*filename,	// New filename
 ...
 */
void
Fl_File_Chooser_Custom::filter(const char *p)		// I - Pattern(s)
{
...
//
// 'Fl_File_Chooser_Custom::newdir()' - Make a new directory.
//

void
Fl_File_Chooser_Custom::newdir()
{
...
void Fl_File_Chooser_Custom::preview(int e)
{
...
//
// 'Fl_File_Chooser_Custom::previewCB()' - Timeout handler for the preview box.
//

void
Fl_File_Chooser_Custom::previewCB(Fl_File_Chooser_Custom *fc) {	// I - File chooser
  fc->update_preview();
}
...
*/
void Fl_File_Chooser_Custom::rescan_keep_filename()
{
...
//
// 'Fl_File_Chooser_Custom::showChoiceCB()' - Handle show selections.
//

void
Fl_File_Chooser_Custom::showChoiceCB()
{
...
//
// 'Fl_File_Chooser_Custom::update_favorites()' - Update the favorites menu.
//

void
Fl_File_Chooser_Custom::update_favorites()
{
  int		i;			// Looping var
  char		pathname[FL_PATH_MAX],	// Pathname
...
//
// 'Fl_File_Chooser_Custom::update_preview()' - Update the preview box...
//

void
Fl_File_Chooser_Custom::update_preview()
{
...
Fl_File_Chooser_Custom::value(int f)	// I - File number
{
  int		i;		// Looping var
  int		fcount;		// Number of selected files
 ...
 */
void
Fl_File_Chooser_Custom::value(const char *filename)
...
//  printf("Fl_File_Chooser_Custom::value(\"%s\")\n", filename == NULL ? "(null)" : filename);
...
/** Shows the Fl_File_Chooser_Custom window.*/
void Fl_File_Chooser_Custom::show()
{
...
void Fl_File_Chooser_Custom::showHidden(int value)
{
  if (value) {
...
void Fl_File_Chooser_Custom::remove_hidden_files()
{
